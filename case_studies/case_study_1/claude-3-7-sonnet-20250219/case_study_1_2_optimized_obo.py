...
def calculate(
    ...
    This function takes two numbers and performs addition, subtraction,
    multiplication, or division based on the operation provided.
    It returns None if the operation is invalid or if division by zero is
    attempted.
