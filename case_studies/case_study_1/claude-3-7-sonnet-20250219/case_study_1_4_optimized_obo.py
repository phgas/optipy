...
def calculate(
    ...
    This function takes two numbers and an operation symbol, then performs
    the corresponding arithmetic operation. It handles division by zero
    and invalid operations by logging errors and returning None.
...
def main() -> None:
    ...
    This function orchestrates the calculator's workflow by displaying
    information, getting user input, performing calculations, and
    showing results.
