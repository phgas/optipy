...
This module provides functionality for simulating and analyzing the dynamics of a carousel system. It includes classes and methods to model the carousel's behavior, run simulations, and analyze the results to find optimal spring stiffness values.

The module uses numerical integration to solve the system dynamics and provides visualization tools to plot the simulation results.
...
>>> print(results[0].spring_stiffness_n_per_m)
100000.0

>>> from carousel_simulation import main
>>> results = main()
>>> print(results[0].displacement_m)
0.00499
"""
