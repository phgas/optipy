...
class DisplacementAnalysisResult(NamedTuple):
    ...
    This class holds the minimum and maximum displacement values, the total displacement,
    and whether the displacement criteria are met.
...
class SimulationResult(NamedTuple):
    ...
    This class holds the spring stiffness, displacement values, and simulation data
...
class CarouselSimulation:
    ...
    def __init__(
        ...
        """
        Initialize the carousel simulation.
    ...
    def system_dynamics(self, _: float, state: list[float]) -> list[float]:
        ...
        ----------
        _: float
            Time (not used in this implementation).
        state: list[float]
    ...
    def plot_results(self, simulation_data: tuple) -> None:
        ...
        ----------
        simulation_data: tuple
            Simulation data as returned by run_simulation().
        """
    ...
    def get_local_extremes(data_series: np.ndarray) -> tuple[list[float], list[float]]:
        """
        Find local extremes in the data series.

        This method identifies local minima and maxima in the given data series.
    ...
    def get_global_extremes(
        ...
        """
        Find global extremes from local extremes.

        This method identifies the global minimum and maximum from the given
        lists of local minima and maxima.
        ...
        -------
        tuple[float | None, float | None, float | None]
            Global minimum, global maximum, and their difference, or None if not available.
        """
        try:
    ...
    def analyze_displacement(
        ...
        This method analyzes the position data to determine if the displacement
        criteria are met.
    ...
    def print_simulation_result(
        ...
        This method prints the results of the displacement analysis in a colored format.
    ...
    def process_stiffness_result(
        ...
        This method processes the results of a simulation with a specific spring stiffness
        and returns a SimulationResult if the criteria are met.
        ...
        -------
        SimulationResult | None
            Simulation result if criteria are met, None otherwise.
        """
    ...
    def _run_single_simulation(
        ...
        This method runs a simulation with a specific spring stiffness and returns
        a SimulationResult if the criteria are met.
    ...
    def find_optimal_spring_stiffness(
        ...
        This method searches for spring stiffness values that meet the displacement
        criteria.
