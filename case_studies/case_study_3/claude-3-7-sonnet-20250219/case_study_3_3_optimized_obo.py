...
This module provides classes and functions to simulate the motion of gondolas on
a tilted carousel, analyze the displacement of the gondolas, and find optimal
spring stiffness values to minimize radial displacement.
...
class DisplacementAnalysisResult(NamedTuple):
    ...
    This class stores the results of analyzing the radial displacement of a
    gondola during simulation, including minimum and maximum positions and
    whether displacement criteria are met.
...
class SimulationResult(NamedTuple):
    ...
    including the spring stiffness used, displacement measurements, and raw
    simulation data.
...
class CarouselSimulation:
    ...
    carousel, analyze the results, and find optimal spring stiffness values to
    minimize radial displacement.

    Attributes
    ----------
    params: CarouselParameters
        Parameters defining the carousel and gondolas.
    ...
    initial_conditions: list[float]
        Initial conditions for the simulation [position, velocity, angle, angular velocity].
    ...
    analyze_displacement(position_data)
        Analyzes the displacement of the gondola from the position data.
    find_optimal_spring_stiffness(search_config)
        Finds optimal spring stiffness values to minimize radial displacement.
    """
    ...
    def __init__(
        ...
        params: CarouselParameters | None
            Parameters defining the carousel and gondolas. If None, default parameters are used.
        simulation_time_s: float
            Duration of the simulation in seconds.
        max_radial_displacement_m: float
            Maximum allowed radial displacement in meters.
    ...
    def system_dynamics(self, _: float, state: list[float]) -> list[float]:
        ...
        This function implements the differential equations that govern the motion
    ...
    def _calculate_velocity_derivative(
        ...
        """
        Calculate the derivative of velocity for the system dynamics.
    ...
    def _calculate_angular_velocity_derivative(
        ...
        """
        Calculate the derivative of angular velocity for the system dynamics.
    ...
    def run_simulation(
        ...
        """
        Run the carousel simulation and return the results.

        This method solves the differential equations of motion for the gondola
        over the specified simulation time.

        Returns
        -------
        tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]
            Time, position, velocity, angle, and angular velocity arrays.
        """
    ...
    def plot_results(self, simulation_data: tuple) -> None:
        """
        Plot the results of the carousel simulation.

        This method creates a figure with four subplots showing position, velocity,
    ...
    def _finalize_plot(self, fig: plt.Figure, axes: list[plt.Axes]) -> None:
        """
        Finalize the plot with titles, labels, and layout adjustments.
    ...
    def analyze_displacement(
        ...
        """
        Analyze the displacement of the gondola from position data.

        Parameters
        ----------
        position_data: np.ndarray
            Array of position values over time.
    ...
    def _run_single_simulation(
        ...
        -------
        SimulationResult | None
            Processed simulation results, or None if an error occurred or criteria not met.
        """
    ...
    def find_optimal_spring_stiffness(
        ...
        """
        Find optimal spring stiffness values to minimize radial displacement.

        This method searches for spring stiffness values that result in radial
        displacement below the specified maximum.

        Parameters
        ----------
        search_config: dict[str, Any]
            Configuration for the search, including start value, step size, and number of results.
