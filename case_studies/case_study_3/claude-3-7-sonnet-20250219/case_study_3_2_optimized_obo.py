...
class CarouselSimulation:
    ...
    def system_dynamics(self, _: float, state: list[float]) -> list[float]:
        ...
        This function calculates the derivatives of the state variables based on the
        current state and system parameters.
    ...
    def run_simulation(
        ...
        Solves the system of differential equations to simulate the carousel dynamics.
    ...
    def plot_results(self, simulation_data: tuple) -> None:
        ...
        Creates a figure with four subplots showing position, velocity, angle, and
        angular velocity.
    ...
    def get_local_extremes(data: np.ndarray) -> tuple[list[float], list[float]]:
        """
        Find local extremes (minima and maxima) in the data.
    ...
    def get_global_extremes(
        ...
        -------
        tuple[float | None, float | None, float | None]
            Global minimum, global maximum, and displacement, or None if not available.
        """
        try:
    ...
    def find_optimal_spring_stiffness(
        ...
        """
        Find the optimal spring stiffness to minimize displacement.

        Parameters
        ----------
        search_config: dict[str, Any]
            Configuration for the search, including start value, step size, and number
            of results.
...
def setup_simulator() -> CarouselSimulation:
    ...
    -------
    CarouselSimulation
        Initialized carousel simulator.
    """
...
def run_optimization(simulator: CarouselSimulation) -> list[SimulationResult]:
    ...
    ----------
    simulator: CarouselSimulation
        Carousel simulator to use for optimization.
