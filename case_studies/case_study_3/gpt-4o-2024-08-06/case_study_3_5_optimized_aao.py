...
A module for simulating the dynamics of a carousel system.

This module provides classes and functions to simulate the dynamics of a carousel
system, analyze displacement, and find optimal spring stiffness for the system.
...
class SimulationResult(NamedTuple):
    """
    Result of the carousel simulation.
...
class CarouselSimulation:
    ...
    This class provides methods to simulate the dynamics of a carousel system,
    analyze displacement, and find optimal spring stiffness for the system.
    ...
    max_radial_displacement_m: float
        The maximum radial displacement in meters.
    ...
    def system_dynamics(self, _: float, state: list[float]) -> list[float]:
        ...
        ----------
        _: float
            The time (not used in this function).
        state: list[float]
    ...
    def get_global_extremes(
        ...
        -------
        tuple[float | None, float | None, float | None]
            The global minima, maxima, and their difference.
        """
        try:
