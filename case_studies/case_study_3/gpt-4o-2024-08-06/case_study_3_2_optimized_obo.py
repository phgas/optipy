...
This module provides a simulation framework for analyzing the dynamics of
a carousel system. It includes classes and functions to model the carousel's
behavior, simulate its motion, and analyze the displacement of the gondola
under various spring stiffness conditions.
...
class CarouselSimulation:
    ...
    This class models the behavior of a carousel with a gondola, allowing for
    the simulation of its motion and analysis of displacement under different
    spring stiffness conditions.
    ...
    def __init__(
        ...
        params: CarouselParameters | None
            The parameters defining the carousel system. Defaults to None.
        simulation_time_s: float
            The total time for which the simulation runs. Defaults to 10.
        max_radial_displacement_m: float
            The maximum allowable radial displacement of the gondola. Defaults
            to 0.005.
        """
        if params is None:
            params = CarouselParameters()
