...
This module provides a simulation for a carousel system, analyzing the 
displacement and finding the optimal spring stiffness for the system. It 
includes classes and functions to model the carousel dynamics, run simulations, 
and analyze results.
...
class CarouselSimulation:
    """
    A class to simulate a carousel system and analyze its displacement.

    This class models the dynamics of a carousel system, allowing for the 
    simulation of its behavior under different spring stiffness values. It 
    provides methods to run simulations, analyze displacement, and find the 
    ...
    get_global_extremes(local_minima, local_maxima)
        Get the global extremes (minima, maxima, and difference) from local 
        extremes.
    analyze_displacement(position_data)
        Analyze the displacement of the carousel system.
    ...
    def __init__(
        ...
        params: CarouselParameters, optional
            The parameters of the carousel system. Defaults to None.
        simulation_time_s: float, optional
            The duration of the simulation in seconds. Defaults to 10.
        max_radial_displacement_m: float, optional
            The maximum allowable radial displacement in meters. Defaults to 
            0.005.
        """
        if params is None:
            params = CarouselParameters()
    ...
    def plot_results(self, simulation_data: tuple) -> None:
        ...
        ----------
        simulation_data: tuple
            The simulation data containing time, position, velocity, angle, and 
            angular velocity.
        """
    ...
    def analyze_displacement(
        ...
        position_data: np.ndarray
            The position data of the carousel system.
    ...
    def find_optimal_spring_stiffness(
        ...
        search_config: dict[str, Any]
            The configuration for the search, including start value, step size, 
