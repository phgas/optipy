...
A module to simulate the dynamics of a carousel system and find the optimal
spring stiffness for the gondola. The simulation considers various parameters
such as gravity, tilt angle, carousel radius, and more.
...
class CarouselSimulation:
    ...
    simulation of gondola displacement and the determination of optimal
    spring stiffness.
    ...
    def __init__(
        ...
        simulation_time_s: float, optional
            The total simulation time in seconds. Defaults to 10.
        max_radial_displacement_m: float, optional
            The maximum allowable radial displacement in meters. Defaults to 0.005.
        """
        if params is None:
            params = CarouselParameters()
    ...
    def process_stiffness_result(
        ...
        -------
        SimulationResult | None
            The simulation result or None if criteria not met.
        """
    ...
    def _run_single_simulation(
        ...
        -------
        SimulationResult | None
            The simulation result or None if an error occurs.
        """
